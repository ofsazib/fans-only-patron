...
} elseif ($_instance->childHasBeenRendered('dtkwrVr')) {
    $componentId = $_instance->getRenderedChildComponentId('dtkwrVr');
    $componentTag = $_instance->getRenderedChildComponentTagName('dtkwrVr');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dtkwrVr');
} else {
    $response = \Livewire\Livewire::mount('followbutton', [ 'profileId' => $profile->id ]);
    $dom = $response->dom;
    $_instance->logRenderedChild('dtkwrVr', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<div class="col-12 col-md-7">
	...
	<div class="postsList">
		<?php echo $__env->make( 'posts.feed', [ 'profile' => $profile, 'pinned' => $pinned ] , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	</div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make( 'welcome' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/crivion/Sites/fanspatrons/public/resources/views/profile/user-profile.blade.php ENDPATH**/ ?>