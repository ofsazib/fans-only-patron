...
} elseif ($_instance->childHasBeenRendered('hP66v0D')) {
    $componentId = $_instance->getRenderedChildComponentId('hP66v0D');
    $componentTag = $_instance->getRenderedChildComponentTagName('hP66v0D');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hP66v0D');
} else {
    $response = \Livewire\Livewire::mount('followbutton', [ 'profileId' => $profile->id ]);
    $dom = $response->dom;
    $_instance->logRenderedChild('hP66v0D', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make( 'welcome' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/works.crivion.com/resources/views/profile/user-profile.blade.php ENDPATH**/ ?>