...
} elseif ($_instance->childHasBeenRendered('kx6SfJD')) {
    $componentId = $_instance->getRenderedChildComponentId('kx6SfJD');
    $componentTag = $_instance->getRenderedChildComponentTagName('kx6SfJD');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('kx6SfJD');
} else {
    $response = \Livewire\Livewire::mount('creators-sidebar');
    $dom = $response->dom;
    $_instance->logRenderedChild('kx6SfJD', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
