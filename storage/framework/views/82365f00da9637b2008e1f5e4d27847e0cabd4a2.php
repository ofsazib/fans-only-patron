...
} elseif ($_instance->childHasBeenRendered('DAkMtMb')) {
    $componentId = $_instance->getRenderedChildComponentId('DAkMtMb');
    $componentTag = $_instance->getRenderedChildComponentTagName('DAkMtMb');
    $dom = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('DAkMtMb');
} else {
    $response = \Livewire\Livewire::mount('followbutton', [ 'profileId' => $profile->id ]);
    $dom = $response->dom;
    $_instance->logRenderedChild('DAkMtMb', $response->id, \Livewire\Livewire::getRootElementTagName($dom));
}
echo $dom;
?>
