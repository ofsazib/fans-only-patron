    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <br />
                <span
                    class="<?php if($u->userFee == opt('payment-settings.site_fee')): ?> text-success <?php else: ?> text-warning <?php endif; ?>">Fee
                    <?php if($u->userFee == opt('payment-settings.site_fee')): ?>
                    (Default)
                    <?php else: ?>
                    (Custom)
                    <?php endif; ?>
                    : <?php echo e($u->userFee); ?>%
                </span>
                <br />
                <a href="/admin/users/custom-fee/<?php echo e($u->id); ?>">Adjust Fee</a>
                <?php else: ?>
                User
                <?php endif; ?>
            </td>
...
<?php endif; ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/crivion/Sites/fanspatrons/public/resources/views/admin/users.blade.php ENDPATH**/ ?>