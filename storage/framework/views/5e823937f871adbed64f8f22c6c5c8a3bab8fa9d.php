...
<div>
	...
	<form method="POST" action="<?php echo e(route( 'saveMembershipFee' )); ?>">
		...
		<div class="shadow-sm card add-padding">
			...
			<strong><i class="fas fa-info-circle mr-1"></i><?php echo app('translator')->get( 'v23.customFee' ); ?></strong>
			<span
				...
				<div class="col-xs-12 col-sm-6">
					<div class="input-group">
						<div class="input-group-prepend">
							<span class="input-group-text" id="basic-addon3"><?php echo e(opt( 'payment-settings.currency_symbol'
								)); ?></span>
						</div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					<select name="payout_gateway" class="form-control">
						<option value="None" <?php if(isset($p) AND $p->payout_gateway == 'None' ): ?> selected
							<?php endif; ?>><?php echo app('translator')->get('profile.None'); ?></option>
						<option value="PayPal" <?php if(isset($p) AND $p->payout_gateway == 'PayPal' ): ?> selected <?php endif; ?>>PayPal
						</option>
						<option value="Bank Transfer" <?php if(isset($p) AND $p->payout_gateway == 'Bank Transfer' ): ?> selected
							<?php endif; ?>><?php echo app('translator')->get('profile.bankTransfer'); ?></option>

						<?php if(opt('card_gateway', 'Stripe') == 'Crypto'): ?>
						<option value="Crypto" <?php if(isset($p) AND $p->payout_gateway == 'Crypto' ): ?> selected
							<?php endif; ?>><?php echo app('translator')->get('v192.crypto'); ?></option>
						<?php endif; ?>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-6">
					<input type="email" class="form-control" name="paypal_email"
						value="<?php if(isset($p) AND $p->payout_gateway == 'PayPal'): ?> <?php echo e($p->payout_details); ?> <?php endif; ?>" />
				</div>
			</div>
			<br>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-10">
					<textarea class="form-control" name="bank_details"
						rows="5"><?php if(isset($p) AND $p->payout_gateway == 'Bank Transfer'): ?> <?php echo e($p->payout_details); ?> <?php endif; ?></textarea>
				</div>
			</div>
		...
		<div class="text-center">
			<input type="submit" name="sbStoreProfile" class="btn btn-lg btn-primary"
				value="<?php echo app('translator')->get('profile.savePayoutDetails'); ?>">
...
<?php echo $__env->make( 'account' , \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/crivion/Sites/fansonly/resources/views/profile/set-fee.blade.php ENDPATH**/ ?>